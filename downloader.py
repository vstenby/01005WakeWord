...
def main():
    ...
    #Get the splits from the csv files.
    ...
    for split in splits:
        ...
        for _, (ID, t1, t2, _, outpath) in tqdm.tqdm(data_split.iterrows(), total = data_split.shape[0], desc=split):
            wf.clip(t1, t2, ID, outpath, ar=args.ar)
